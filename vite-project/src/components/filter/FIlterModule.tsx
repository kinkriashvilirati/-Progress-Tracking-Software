...
export default function FilterModule({ isFilter, filterType }: FilterProps) {
  return (
    <div
      className={`absolute bg-bg ${isFilter ? "block" : "hidden"} border-border-gray border rounded-2xl  top-35 sm:bottom-auto sm:top-10 max-h- w-full py-2 my-3 lg:px-3 right-0`}
    >
